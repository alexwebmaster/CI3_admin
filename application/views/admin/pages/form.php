	...
	<div class="tab-content">
		<div class="tab-pane active" id="content_tab">
			<fieldset>
				...
				<?php
				$data	= array('name'=>'title', 'value'=>set_value('title', $title), 'class'=>'col-12');
		...
		<div class="tab-pane" id="attributes_tab">
			<fieldset>
				...
				<?php
				$data	= array('name'=>'menu_title', 'value'=>set_value('menu_title', $menu_title), 'class'=>'col-3');
				echo form_input($data);
				?>
			
				<label for="slug"><?php echo lang('slug');?></label>
				<?php
				$data	= array('name'=>'slug', 'value'=>set_value('slug', $slug), 'class'=>'col-3');
				echo form_input($data);
				?>
				...
				<?php
				$data	= array('name'=>'sequence', 'value'=>set_value('sequence', $sequence), 'class'=>'col-3');
				echo form_input($data);
				?>
			</fieldset>
		</div>
		...
		<div class="tab-pane" id="seo_tab">
			<fieldset>
				...
				<?php
				$data	= array('name'=>'seo_title', 'value'=>set_value('seo_title', $seo_title), 'class'=>'col-12');
				echo form_input($data);
				?>
			
				<label><?php echo lang('meta');?></label>
				<?php
				$data	= array('rows'=>'3', 'name'=>'meta', 'value'=>set_value('meta', html_entity_decode($meta)), 'class'=>'col-12');
				echo form_textarea($data);
				?>
