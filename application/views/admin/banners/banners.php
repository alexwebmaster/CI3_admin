...
<a style="float:right;" class="btn btn-primary" href="<?php echo site_url($this->config->item('admin_folder').'/banners/form'); ?>"><i class="fas fa-plus"></i> <?php echo lang('add_new_banner');?></a>
		...
		<tr id="banners-<?php echo $banner->id;?>">
			...
			<td>
				<div class="btn-group" style="float:right">
					<a class="btn btn-primary" href="<?php echo  site_url($this->config->item('admin_folder').'/banners/form/'.$banner->id);?>"><i class="fas fa-pencil-alt"></i> <?php echo lang('edit');?></a>
					<a class="btn btn-danger" href="<?php echo  site_url($this->config->item('admin_folder').'/banners/delete/'.$banner->id);?>" onclick="return areyousure();"><i class="fas fa-trash"></i> <?php echo lang('delete');?></a>
				</div>
			</td>
		</tr>
	<?php endforeach; ?>
