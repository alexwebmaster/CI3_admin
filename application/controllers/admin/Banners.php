...
class Banners extends Admin_Controller {
	...
	function index()
	{
		...
		$this->view(config_item('admin_folder').'/banners/banner_collections', $data);
	}
	...
	function banner_collection_form($banner_collection_id = false)
	{
		...
		{
			$this->view(config_item('admin_folder').'/banners/banner_collection_form', $data);
		}
		else
		{
	...
	function banner_collection($banner_collection_id)
	{
		...
		$this->view(config_item('admin_folder').'/banners/banner_collection', $data);
	}
	...
	function banner_form($banner_collection_id, $id = false)
	{
		...
		if ($this->form_validation->run() == false)
		{
			...
			$this->view(config_item('admin_folder').'/banners/banner_form', $data);
		}
		else
		{	
			...
			$save['new_window']				= (int)$this->input->post('new_window');
