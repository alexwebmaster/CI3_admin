...
class Pages extends Admin_Controller
{
	...
	function index()
	{
		...
		$this->view($this->config->item('admin_folder').'/pages/list', $data);
	}
	...
	********************************************************************/
	function form($id = false)
	{
		...
		{
			$this->view($this->config->item('admin_folder').'/pages/form', $data);
		}
		else
		{
	...
	function link_form($id = false)
	{
		...
		if($this->form_validation->run() == false)
		{
			$this->view($this->config->item('admin_folder').'/pages/link_form', $data);
		}
		else
		{	
			$save = array();
