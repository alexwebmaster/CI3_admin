...
Class Banner_model extends CI_Model
{
	...
	function banner_collection_banners($banner_collection_id, $only_active=false, $limit=false)
	{
	...
	function get_category_banners($category_id = 0 , $only_active=false,  $limit = false)
	{
		$this->db->where('category_id', $category_id);
		$this->db->where('banner_collection_id', 3);
		$banners	= $this->db->order_by('sequence ASC')->get('banners')->result();
